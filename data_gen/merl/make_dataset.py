...
indir = "/home/vig-titan2/Data/SVL-nerf_data/brdf_merl"
ims = '256'
outdir = "/home/vig-titan2/Data/SVL-nerf_data/brdf_merl_npz/ims256_envmaph16_spp1"

flags.DEFINE_string('indir', indir, "directory to downloaded MERL binary files")
...
flags.DEFINE_integer('ims', ims, "render size during visualization")
flags.DEFINE_integer('spp', 1, "samples per pixel for BRDF rendering")
flags.DEFINE_string('outdir', outdir, "output directory")
