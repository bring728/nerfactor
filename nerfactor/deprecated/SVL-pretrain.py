...
# data_type = 'obj_'
data_type = 'scene_'
# train_mode = 'nerf_pretrain'
# train_mode = 'geometry_pretrain'
train_mode = 'Joint_Optimization'
debug = False
...
if train_mode == 'nerf_pretrain':
    os.environ["CUDA_VISIBLE_DEVICES"] = "0,1"
    os.environ["TF_GPU_THREAD_MODE"] = "gpu_private"
    config_ini = data_type + 'simple_nerf.ini'
    outroot = '/home/vig-titan2/Data/SVL-nerf_data/output/train/' + scene + '/' + data_type + scene + '_nerf'
    config_override = "data_root=" + data_root + ",outroot=" + outroot + ",viewer_prefix=''"

if train_mode == 'geometry_pretrain':
    os.environ["CUDA_VISIBLE_DEVICES"] = "0"
    os.environ["TF_GPU_THREAD_MODE"] = "gpu_private"
    config_ini = 'scene_simple_shape.ini'
    shape_outdir = '/home/vig-titan2/Data/SVL-nerf_data/output/train/' + scene + '/' + data_type + scene + '_shape'
    surf_root = "/home/vig-titan2/Data/SVL-nerf_data/output/surf/" + data_type + scene + '_nerf'
    config_override = "data_root=" + data_root + ",outroot=" + shape_outdir + ",viewer_prefix=''" + ",data_nerf_root=" + surf_root

if train_mode == 'Joint_Optimization':
    os.environ["CUDA_VISIBLE_DEVICES"] = "0, 1"
    os.environ["TF_GPU_THREAD_MODE"] = "gpu_private"
    config_ini = 'scene_simple_nerfactor.ini'
    shape_outdir = '/home/vig-titan2/Data/SVL-nerf_data/output/train/' + scene + '/' + data_type + scene + '_shape'
    outroot = '/home/vig-titan2/Data/SVL-nerf_data/output/train/' + scene + '/' + data_type + scene + '_nerfactor'
    surf_root = "/home/vig-titan2/Data/SVL-nerf_data/output/surf/" + data_type + scene + '_nerf'
    shape_ckpt = shape_outdir + "/lr1e-2/checkpoints/ckpt-2"
    brdf_ckpt = "/home/vig-titan2/Data/SVL-nerf_data/Shared model/merl/lr1e-2/checkpoints/ckpt-50"
    test_envmap_dir = "/home/vig-titan2/Data/SVL-nerf_data/light-probes/test"
...
flags.DEFINE_string('config', config_ini, "base .ini file in config/ or a full path")
flags.DEFINE_string('config_override', config_override, "")
flags.DEFINE_boolean('debug', debug, "debug mode switch")
flags.DEFINE_enum('device', 'gpu', ['cpu', 'gpu'], "running on what type of device(s)")
FLAGS = flags.FLAGS

logger = logutil.Logger(loggee="SVL-pretrain")
...
def main(_):
    ...
    distributed_train_step_decor = distributed_train_step if FLAGS.debug else tf.function(distributed_train_step)
    # distributed_train_step_decor = distributed_train_step
