...
class Model(BaseModel):
    ...
    def call(self, batch, mode='train'):
        ...
        id_, hw, rayo, rayd, rgb, radii = batch  # all flattened
        pred_coarse, pred_fine = self._render_rays(rayo, rayd, radii, mode=mode)
    ...
    def gen_z_fine(z_coarse, weights, n_samples_fine, perturb=False):
        ...
        # (n_rays, n_samples_coarse + n_samples_fine)
    ...
    def _render_rays(self, rayo, rayd, radii, mode='train'):
