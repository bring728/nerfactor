...
outroot = '/home/vig-titan2/Data/SVL-nerf_data/Shared model/merl'
...
def main(_):
    ...
    for batch_i, batch in enumerate(tqdm(datapipe, desc="BRDFs", total=n_brdfs)):
        # for batch_i, batch in enumerate(tqdm(datapipe, desc="BRDFs", total=20)):
