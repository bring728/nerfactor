...
# imh = '720'
# trained_nerf = '/home/vig-titan2/Data/SVL-nerf_data/output/train/' + scene + '/' + data_type + scene + "_nerf/lr5e-4"
# scene_bbox = '-0.6,0.6,0.3,1.4,3.0,4.0'
...
lr = '5e-4'
trained_nerf = root_dir + "output/train/" + scene + '/' + scene + "_nerf/lr5e-4_far3.0_noise0.0"
occu_thres = '0.5'

mlp_chunk = '500000'  # bump this up until GPU gets OOM for faster computation
...
def process_view(config, model, batch, mode):
    ...
    occu, exp_depth, exp_normal = compute_depth_and_normal(model, rayo, rayd, config)
